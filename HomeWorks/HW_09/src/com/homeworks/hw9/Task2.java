...
//Задача 2.
//
//Предположим, что есть два массива чисел,
// каждый из которых отсортирован в порядке возрастания.
// Реализуйте метод int[] merge(int[], int[]),
// который объединяет эти массивы в один отсортированный массив.
